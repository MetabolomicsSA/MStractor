...
## 10. _Descriptive Statistics and Box plots_

Step 10 allows calculating  descriptive statistics 
...
```{r eval=FALSE}
storeRefFeat()
spectraFromScan(RefFeat)
nistEntryFromScan(spectralist, RefFeatScan)
createSearchList("spectralist")
```
